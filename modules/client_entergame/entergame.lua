...
function EnterGame.init()
    ...
    EnterGame.setUniqueServer(ServerInit.login, ServerInit.port, ServerInit.protocol)
    EnterGame.setHttpLogin(true)
...
function EnterGame.setUniqueServer(host, port, protocol, windowWidth, windowHeight)
    ...
    local serverListButton = enterGame:getChildById('autoLoginBox')
    serverListButton:setVisible(false)
    serverListButton:setHeight(0)
    local serverListButton = enterGame:getChildById('httpLoginBox')
    httpLoginBox:setVisible(false)
    httpLoginBox:setHeight(0)
